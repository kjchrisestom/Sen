...
// Edit the data
$que="UPDATE `save-history` SET `MemberID` ='$member',
 `Date`='$DOB',
  `Amount`='$ammount',
`saved-by`='$save',
`Recieved-By`='$recieved' WHERE `HistoryID` ='$id'";
...
if (isset($_POST['QUPM']))
{
	$id=$_GET['id'];
$member=$_POST['member'];
$que="DELETE from `save-history`  WHERE `HistoryID` ='$id'";
  $updatequery = mysqli_query($GOO, $que);
  //echo $que;
  if(!$updatequery)  {
	  $message="Error updating database".die(mysql_error());
...
/* include'connection.php'; */
 ...
 if(isset($_GET['id']))
 {
	 ...
	 $id=$_GET['id'];
	 $john=mysqli_query( $GOO,"SELECT * FROM `save-history` WHERE `HistoryID` ='$id'");
	 if(!$john)
	 {
 ...
 <label class="control-label col-sm-2" for="FName">MemberID:</label>
 <div class="col-sm-9"><input type="text" class="form-control" readonly="readonly" id="fn"  name="member"  value="'.$row['MemberID'].'" />
 </div></div>
 
  <div class="form-group" >
 <label class="control-label col-sm-2" for="Date">Date:</label>
 <div class="col-sm-9"><input type="text" class="form-control" id="Date"  name="Date"  value="'.$row['Date'].'" />
 </div></div>
 
 <div class="form-group" >
 <label class="control-label col-sm-2" for="Amount">Amount:</label>
 <div class="col-sm-9"><input type="text" class="form-control" id="ammount" name="ammount"  value="'.$row['Amount'].'" />
 </div></div><br/>';
		  	
		 echo'<div class="form-group" >
 <label class="control-label col-sm-2" for="SavedBy">SavedBy:</label>
 <div class="col-sm-9"><input type="text" class="form-control" id="saved" name="save" value="'.$row['saved-by'].'" />
 </div></div><br/>';
		 
		  echo'<div class="form-group" >
 <label class="control-label col-sm-2" for="RecievedBy">RecievedBy:</label>
 <div class="col-sm-9">
 <input type="text" class="form-control" readonly="readonly" id="recievedby" name="recieved" value="'.$row['Recieved-By'].'" />
 </div></div>';
		 
		  echo'<div class="form-group col-sm-10">        
      <div class=" text-right col-sm-4">
        <button type="submit" class="btn btn-success" name="PUPM">Update</button>
       
      </div>
            
      <div class="col-sm-1">
        <button type="submit" class="btn btn-warning" name="QUPM">Delete</button>
      </div>
