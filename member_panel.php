        ...
        <div class="navbar-inner">
            ...
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu">
                    <li><a href="member_pro.php">Profile</a></li>
                    <li class="divider"></li>
			...
			<li><a href="member_panel.php"><i class="glyphicon glyphicon-home"></i>  Home</a></li>
			<li><a href="member_loan.php"><i class="glyphicon glyphicon-globe"></i> Get loan</a></li>
			<li><a href="member_pro.php"><i class="glyphicon glyphicon-user"></i> My Profile</a></li>
			 </ul>

        </div>
    </div>
    <!-- topbar ends -->
<div class="ch-container" style="padding-left:5%;">
    <div class="row">
        ...
        <div id="content" class="col-lg-11 col-sm-10" style="padding-left:3%;" >
            <!-- content starts -->
            <div>
    <ul class="breadcrumb">
        <li>
...
<div class=" row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Monthly Payment" class="well top-block" href="#">
            <i class="glyphicon glyphicon-envelope red"></i>
				<?php  
			$men="select sum(Total) from save where MemberID='$john'";
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Loan Approved" class="well top-block" href="#">
            <i class="glyphicon glyphicon-envelope red"></i>
				<?php  
			$men="select count(loanID) from get Where MemberID='$john'";
			$ret= mysqli_query($GOO,$men);
			while($row=mysqli_fetch_array($ret))
			{
			$value=$row['count(loanID)'];
			}
			?>
    ...
    <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Withdraw." class="well top-block" href="#">
            <i class="glyphicon glyphicon-envelope red"></i>
			<?php  
			$men="select sum(withdrew) from withdraw where MemberID ='$john'";
			$ret= mysqli_query($GOO,$men);
			while($row=mysqli_fetch_array($ret))
			{
       ...
       <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="Loan Payment" class="well top-block" href="#">
            <i class="glyphicon glyphicon-envelope red"></i>
						<?php  
			$men="select sum(Sum) from loaner where MemberID = '$john'";
			$moon= mysqli_query($GOO,$men);
			while($row=mysqli_fetch_array($moon))
			{
			$value=$row['sum(Sum)'];
			}
			?>
