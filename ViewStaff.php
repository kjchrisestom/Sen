...
<tr class='info'> <th>StaffID</th><th>FName</th><th>LName</th><th>DOB</th><th>Address</th><th>Role</th><th>Actions</th></tr>";
...
echo '<td><a href="satffedit.php?id='.$row['StaffID'].'"><span class="glyphicon glyphicon-filter"></span> Actions</a></td>';
echo"</tr>";
}
echo"</tr></table>";
	?>
