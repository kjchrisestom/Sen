...
// Edit the data
$que="UPDATE Staff SET StaffID ='$member', `FName`='$fn', `LName`='$ln', 
 `Address`='$adre', Designation ='$pass',
`Password`='$phone' WHERE StaffID ='$id'";
//echo $que;
...
$id=$_GET['id'];
$member=$_POST['member'];
$que="DELETE from Staff  WHERE StaffID ='$id'";
  $updatequery = mysqli_query( $GOO,$que);
  //echo $que;
  if(!$updatequery)  {
...
<div class="row" style="width:101%; padding-left:1%;">
	...
	<div class="contianer" style="padding-left:0%">
                     <div class="panel panel-info">
                          ...
                          <strong>  EDIT STAFF MEMBER'S PERSONAL DATA FOR SENK SACCO </strong>    
                            </div>
						...
						<?php
						 ...
						 if(isset($_GET['id']))
						 {
							 ...
							 $id=$_GET['id'];
							 $john=mysqli_query($GOO,"SELECT * FROM staff WHERE StaffID='$id'");
							 if(!$john)
							 {
						 ...
						 <label class="control-label col-sm-2" for="MemberID">StaffID:</label>
						 <div class="col-lg-8"><input type="text" class="form-control" id="fn"  name="member"  value="'.$row['StaffID'].'" />
						 </div></div>
						 ...
						 <div class="col-lg-8"><input type="text" class="form-control" id="fn"  name="phone"  value="'.$row['Password'].'" />
						 </div></div>
						 
						 <div class="form-group" >
						  <label class="control-label col-sm-2" for="MemberID">Role:</label>
						 <div class="col-lg-8"><input type="text" class="form-control" id="fn"  name="pass"  value="'.$row['Designation'].'" />
						 </div></div>
						 

						 <div class="form-group col-sm-10">        
							  <div class=" text-right col-sm-4">
								<button type="submit" class="btn btn-success" name="UPM">Update Staff</button>
							   
							  </div>
									
							  <div class="col-sm-1">
								<button type="submit" class="btn btn-info" name="DUPM">Delete Staff</button>
							  </div>
						 ';
								/* 
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy copy; <a href="http://usman.it" target="_blank">Muhammad
                Usman</a> 2012 - 2015</p>
