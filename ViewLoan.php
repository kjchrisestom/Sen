...
//echo $con;
$sel=mysqli_select_db($con,"senk"); */
$pay=mysqli_query($GOO,"select * from get ");
/*echo"<table cellpadding='2' cellspacing='2' bordercolor='#999999'> <tr colspan='4'>";*/

echo"<table class=\"table table-bordered table-hover table stripped\" ><tr class='info'> <th>MemberID</th><th>Type of loan</th><th>Mode of payment</th><th>Month</th><th>Ammount</th><th>Interesr Rate</th>
<th>Total Loan</th><th>Releas Date</th><th>Start Date</th><th>Maturity Date</th><th>Status</th><th>Actions</th></tr>";
...
echo '<td><a href="loanedit.php?id='.$row['loanID'].'"><span class="glyphicon glyphicon-filter"></span> Action</a></td>';
echo"</tr>";
