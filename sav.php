...
$stat=$_POST['stat'];
// Edit the data
$que="UPDATE `get` SET `MemberID` ='$member', `tol`='$DOB', `mop`='$ammount', `moth`='$Total',
`ea`='$save', `ir`='$recieved'
`ta`='',`rd`='',
`sd`='',`md`='',Status='$stat' WHERE `MemberID` ='$id'";
...
if (isset($_POST['QUPM']))
{
$que="DELETE from `get`  WHERE `MemberID` ='$id'";
  $updatequery = mysqli_query( $GOO,$que);
  //echo $que;
  if(!$updatequery)  {
                   ...
                   <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="accordion">
                            ...
                            <ul class="nav nav-pills nav-stacked">
								...
								<li><a href="ViewWithdraw.php">View  Withdraw</a></li>                            </ul>
                        </li>
                        <li class="accordion">
                        ...
                        <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-eye-close"></i><span> Add Individuals</span></a>
                            <ul class="nav nav-pills nav-stacked">
...
$cus=mysqli_query($GOO,"select * from `save-history` ");
echo"<table class=\"table table-bordered table-hover table stripped\" >
<tr class='info'><th>MemberID</th><th>Date</th><th>Amount </th><th>Saved By</th><th>Recieved By</th><th>Actions</th></tr>";
...
echo'<td><a href="savedit.php?id='.$row['HistoryID'].'"><span class="glyphicon glyphicon-filter"></span> Action</a></td>';
echo"<tr>";
