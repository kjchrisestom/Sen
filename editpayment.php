 ...
 if (isset($_POST['up']))
{
	$id=$_GET['id'];
$Code=$_POST['member'];
//$LoanApro=$_POST['account'];
//$Interest=$_POST['Balance'];
$AmountPaid=$_POST['Instalement'];
//$Balance=$_POST['Current'];
$Date=$_POST['date'];
$Paidby=$_POST['paid'];
$Aprovedby=$_POST['aproved'];


// Edit the data
$sql="UPDATE `instale-history` SET 
 `MemberID`='$Code', 
  
`Installement`='$AmountPaid',
 
  Date='$Date',
`Paid_By`='$Paidby',
 `Aproved_by`='$Aprovedby' WHERE PayID ='$id'";
  $updatequery = mysqli_query($GOO, $sql);
...
{
$id=$_GET['id'];
$sql="DELETE from `instale-history`  WHERE PayID ='".$id."'";
  $updatequery = mysqli_query($GOO, $sql);
...
<div class="row" style="width:101%;">
 ...
 <div class="panel panel-info">
                          ...
                          <strong>  EDIT LOAN PREPAY MADE MEMBER  FOR SENK SACCO </strong>    
                            </div>
 ...
 if(isset($_GET['id']))
 {
	 ...
	 $id=$_GET['id'];
	 $qry=mysqli_query($GOO,"SELECT * FROM `instale-history` WHERE PayID='$id'");
	 if(!$qry)
	 {
...
<label class="control-label col-sm-2" for="Member ID">Member ID:</label>
 <div class="col-lg-10"><input type="text" class="form-control" id="fn"  name="member"  value="'.$row['MemberID'].'" />
 </div></div>';

 echo'<div class="form-group" >
 <label class="control-label col-sm-2" for="Instalement">Instalement:</label>
 <div class="col-lg-10">
 <input type="text" class="form-control" id="fn"  name="Instalement"  value="'.$row['Installement'].'" />
 </div></div>';
  
echo'<div class="form-group" >
<label class="control-label col-sm-2" for="Instalement">Date:</label>
 <div class="col-lg-10"><input type="text" class="form-control" id="fn"  name="date"  value="'.$row['Date'].'" />
 </div></div>';
 
 echo'<div class="form-group" >
 <label class="control-label col-sm-2" for="Instalement">Paid BY:</label>
 <div class="col-lg-10"><input type="text" class="form-control" id="fn"  name="paid"  value="'.$row['Paid_By'].'" />
 </div></div>';
 
 echo'<div class="form-group" >
 <label class="control-label col-sm-2" for="Instalement">Recived By:</label>
 <div class="col-lg-10"><input type="text" class="form-control" id="fn"  name="aproved"  value="'.$row['Aproved_by'].'" />
 </div></div>';
  echo'
   <div class="form-group col-sm-10">        
      <div class=" text-right col-sm-4">
        <button type="submit" class="btn btn-success" name="up">Update Loan Prepay</button>
       
      </div>
            
      <div class="col-sm-1">
        <button type="submit" class="btn btn-info" name="CDus">Delete Loan Prepay</button>
      </div>';
	 }
	 echo'</div></form>';
	 }
