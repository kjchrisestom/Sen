...
echo"<table class=\"table table-hover table-bordered table stripped col-sm-9\" style='padding-left:20%'  >
 <tr class='info'><th>#</th><th>MemberID</th><th>Date</th><th>Withdrew</th><th>Recieved</th><th>Action</th></tr>";
...
echo '<td><a href="editwithdraw.php?id='.$row['WithdrawID'].'"><span class="glyphicon glyphicon-filter"></span> Action</a></td>';
echo"</tr>";
